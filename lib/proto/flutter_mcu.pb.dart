...
class ProtoUpdateWithSingleImageCallArguments extends $pb.GeneratedMessage {
  factory ProtoUpdateWithSingleImageCallArguments({
    $core.String? deviceUuid,
  ...
  ProtoUpdateWithSingleImageCallArguments._() : super();
  factory ProtoUpdateWithSingleImageCallArguments.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ProtoUpdateWithSingleImageCallArguments.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProtoUpdateWithSingleImageCallArguments', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'deviceUuid')
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ProtoUpdateWithSingleImageCallArguments clone() => ProtoUpdateWithSingleImageCallArguments()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProtoUpdateWithSingleImageCallArguments copyWith(void Function(ProtoUpdateWithSingleImageCallArguments) updates) => super.copyWith((message) => updates(message as ProtoUpdateWithSingleImageCallArguments)) as ProtoUpdateWithSingleImageCallArguments;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ProtoUpdateWithSingleImageCallArguments create() => ProtoUpdateWithSingleImageCallArguments._();
  ProtoUpdateWithSingleImageCallArguments createEmptyInstance() => create();
  static $pb.PbList<ProtoUpdateWithSingleImageCallArguments> createRepeated() => $pb.PbList<ProtoUpdateWithSingleImageCallArguments>();
  @$core.pragma('dart2js:noInline')
  static ProtoUpdateWithSingleImageCallArguments getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ProtoUpdateWithSingleImageCallArguments>(create);
  static ProtoUpdateWithSingleImageCallArguments? _defaultInstance;
